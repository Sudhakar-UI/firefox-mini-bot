            ...
            <div className='main-page'>
                <Container>
                    ...
                    <div className="d-flex justify-content-around mt-4">
                        ...
                        <Link href="/paymentpage" className="d-flex flex-column align-items-center main-links">
                            <div className="trsicon">
                                <TransferIcon size={20} />
                            </div>
                            <span className="txt-clor">Transfer</span>
                        </Link>
                        <Link href="/history-all" className="d-flex flex-column align-items-center main-links">
                            <div className="trsicon">
                                <HistoryIcon size={20} />
                            </div>
